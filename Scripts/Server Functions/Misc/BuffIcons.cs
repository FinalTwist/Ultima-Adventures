...
namespace Server
{
	...
	public enum BuffIcon : short
	{
		...
		Cunning,			//*
		Strength,			//*
		Bless,				//  All Bufficons added after UA
        	Sleep,				//  Already in UA, but never used
        	StoneForm,			//  Already in UA, but never used
        	SpellPlague,		//  Already in UA, but never used
        	Berserk,			//  Already in UA, but never used
        	MassSleep,			//  Already in UA, but never used
        	Fly,				//  Already in UA, but never used
		Inspire,
		Invigorate,
        	Resilience,
        	Perseverance,
