...
namespace Knives.Chat3
{
    ...
    public class Channel
    {
        ...
        public virtual void OnChat(Mobile m, string msg, bool spam)
        {
            ...
            if (Data.LogChat)
                Logging.LogChat(String.Format(DateTime.UtcNow + " <{0}{1}> {2}: {3}", c_Name, (c_Style == ChatStyle.Regional && m.Region != null ? "-" + Server.Misc.Worlds.GetRegionName( m.Map, m.Location ) : ""), m.RawName, msg));
