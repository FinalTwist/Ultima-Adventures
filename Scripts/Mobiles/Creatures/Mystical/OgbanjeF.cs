...
namespace Server.Mobiles
{
	...
	public class Ogbanje : BaseCreature
	{
		...
		[Constructable]
		public Ogbanje() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) // NEED TO CHECK
		{
			Name = "a ogbanje";
			Body = 0x24;
		...
		public Ogbanje( Serial serial ) : base( serial )
		{
		}
