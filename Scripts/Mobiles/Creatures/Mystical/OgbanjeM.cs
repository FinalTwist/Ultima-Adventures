...
{
	[CorpseName( "a childs corpse" )]
	public class OgbanjeM : BaseCreature
	{
		...
		[Constructable]
		public OgbanjeM() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) // NEED TO CHECK
		{
			Name = "a ogbanje";
			Body = 0x26;
		...
		public OgbanjeM( Serial serial ) : base( serial )
		{
		}
