...
namespace Server.Mobiles
{
	...
	public class FaeFolk : BaseCreature
	{
		...
		[Constructable]
		public FaeFolk() : base( AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "pixie" );
			Title = "of the faefolk";
			Body = 356;
			BaseSoundID = 0x467;
		...
		public FaeFolk( Serial serial ) : base( serial )
		{
		}
