...
{
	[CorpseName( "a Meepter corpse" )]
	public class Meepter : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Ratman; } }

		[Constructable]
		public Meepter() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Meepter";
			Body = 245;
			BaseSoundID = 0x543;
		...
		public Meepter( Serial serial ) : base( serial )
		{
		}
