...
{
	[CorpseName( "a aqueath corpse" )]
	public class AqueathHighborn : BaseCreature
	{
		...
		[Constructable]
		public AqueathHighborn() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Aqueath Highborn";
			Body = 676;
			BaseSoundID = 0x553;
			CanSwim = true;
		...
		public AqueathHighborn( Serial serial ) : base( serial )
		{
		}
