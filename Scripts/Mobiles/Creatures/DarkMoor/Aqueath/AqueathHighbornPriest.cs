...
namespace Server.Mobiles
{
	...
	public class AqueathHighbornPriest : BaseCreature
	{
		...
		[Constructable]
		public AqueathHighbornPriest() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an Aqueath Highborn Priest";
			Body = 677;
			BaseSoundID = 0x553;
			CanSwim = true;
		...
		public AqueathHighbornPriest( Serial serial ) : base( serial )
		{
		}
