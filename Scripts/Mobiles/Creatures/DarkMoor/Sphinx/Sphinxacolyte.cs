...
namespace Server.Mobiles
{
	...
	public class SphinxAcolyte : BaseCreature
	{
		...
		[Constructable]
		public SphinxAcolyte () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a sphinx acolyte";
			Body = 788;
			BaseSoundID = 0x668;
		...
		public SphinxAcolyte( Serial serial ) : base( serial )
		{
		}
