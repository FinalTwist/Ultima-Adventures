...
namespace Server.Mobiles
{
	...
	public class GodlySphinx : BaseCreature
	{
		...
		[Constructable]
		public GodlySphinx () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Godly Sphinx";
			Body = 314;
			BaseSoundID = 0x668;
		...
		public GodlySphinx( Serial serial ) : base( serial )
		{
		}
