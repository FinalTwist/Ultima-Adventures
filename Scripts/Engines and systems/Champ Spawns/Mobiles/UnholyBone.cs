		...
		private class SpawnTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				switch ( Utility.Random( 12 ) )
				{
					...
					case 2: spawn = new ChampionWraith(); break;
					case 3: spawn = new Spectre(); break;
					case 4: spawn = new Ghoul(); break;
					case 5: spawn = new Mummy(); break;
					case 6: spawn = new Bogle(); break;
					case 7: spawn = new ChampionRottingCorpse(); break;
					case 8: spawn = new ChampionBoneKnight(); break;
					case 9: spawn = new ChampionSkeletalKnight(); break;
					case 10: spawn = new ChampionLich(); break;
					case 11: spawn = new ChampionLichLord(); break;
				}
