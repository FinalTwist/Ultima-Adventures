...
namespace Server.Mobiles
{
	...
	public class Champion2Centaur : BaseCreature
	{
		[Constructable]
		public Champion2Centaur() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public Champion2Centaur( Serial serial ) : base( serial )
		{
		}
