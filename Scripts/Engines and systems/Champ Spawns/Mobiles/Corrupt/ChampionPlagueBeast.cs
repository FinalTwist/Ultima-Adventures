...
{
	[CorpseName( "a plague beast champion corpse" )]
	public class ChampionPlagueBeast : BaseCreature, IDevourer
	{
		...
		[Constructable]
		public ChampionPlagueBeast() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionPlagueBeast( Serial serial ) : base( serial )
		{
		}
