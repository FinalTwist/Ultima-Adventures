...
{
	[CorpseName("a plague beast lord champion corpse")]
	public class ChampionPlagueBeastLord : BaseCreature, ICarvable, IScissorable
	{
        ...
        [Constructable]
        public ChampionPlagueBeastLord() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
		ChampionHue();
	...
	public override void GenerateLoot()
	{
        ...
        public ChampionPlagueBeastLord(Serial serial) : base(serial)
        {
        }
        ...
        {
		private ChampionPlagueBeastLord m_Lord;
		private int m_Count;
		...
		public DecayTimer(ChampionPlagueBeastLord lord) : this(lord, 0, 120)
		{
		}

		public DecayTimer(ChampionPlagueBeastLord lord, int count, int deadline) : base(TimeSpan.Zero, TimeSpan.FromSeconds(1))
		{
			m_Lord = lord;
			m_Count = count;
			m_Deadline = deadline;
