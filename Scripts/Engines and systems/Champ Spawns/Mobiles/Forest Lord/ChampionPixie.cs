...
namespace Server.Mobiles
{
	...
	public class ChampionPixie : BaseCreature
	{
		public override bool InitialInnocent{ get{ return true; } }

		[Constructable]
		public ChampionPixie() : base( AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionPixie( Serial serial ) : base( serial )
		{
		}
