...
namespace Server.Mobiles
{
	...
	public class ChampionShadowWisp : BaseCreature
	{
		[Constructable]
		public ChampionShadowWisp() : base( AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.3, 0.6 )
		{
			ChampionHue();
		...
		public ChampionShadowWisp( Serial serial ) : base( serial )
		{
		}
