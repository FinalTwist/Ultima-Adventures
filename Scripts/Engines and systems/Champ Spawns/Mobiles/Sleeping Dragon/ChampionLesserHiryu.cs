...
{
	[CorpseName( "a hiryu champion corpse" )]
	public class ChampionLesserHiryu : BaseMount
	{
		...
		[Constructable]
		public ChampionLesserHiryu() : base( "a lesser hiryu", 243, 0x3E94, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Hue = GetHue();
		...
		public ChampionLesserHiryu( Serial serial ) : base( serial )
		{
		}
