...
namespace Server.Mobiles
{
	...
	public class ChampionDragon : BaseCreature
	{
		[Constructable]
		public ChampionDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionDragon( Serial serial ) : base( serial )
		{
		}
