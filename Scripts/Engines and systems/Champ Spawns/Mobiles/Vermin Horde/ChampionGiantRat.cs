...
{
	[CorpseName( "a giant rat champion corpse" )]
	public class ChampionGiantRat : BaseCreature
	{
		[Constructable]
		public ChampionGiantRat() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionGiantRat(Serial serial) : base(serial)
		{
		}
