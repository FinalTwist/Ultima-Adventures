...
{
	[CorpseName( "a dire wolf champion corpse" )]
	public class ChampionDireWolf : BaseCreature
	{
		[Constructable]
		public ChampionDireWolf() : base( AIType.AI_Melee,FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionDireWolf(Serial serial) : base(serial)
		{
		}
