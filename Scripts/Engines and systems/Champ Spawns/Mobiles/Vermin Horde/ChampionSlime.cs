...
{
	[CorpseName( "a slimey champion corpse" )]
	public class ChampionSlime : BaseCreature
	{
		[Constructable]
		public ChampionSlime() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionSlime( Serial serial ) : base( serial )
		{
		}
