...
{
	[CorpseName( "a succubus champion corpse" )]
	public class ChampionSuccubus : BaseCreature
	{
		[Constructable]
		public ChampionSuccubus () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionSuccubus( Serial serial ) : base( serial )
		{
		}
