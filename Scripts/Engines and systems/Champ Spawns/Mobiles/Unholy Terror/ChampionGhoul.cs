...
namespace Server.Mobiles
{
	...
	public class ChampionGhoul : BaseCreature
	{
		[Constructable]
		public ChampionGhoul() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionGhoul( Serial serial ) : base( serial )
		{
		}
