...
namespace Server.Mobiles
{
	...
	public class ChampionBoneKnight : BaseCreature
	{
		[Constructable]
		public ChampionBoneKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionBoneKnight( Serial serial ) : base( serial )
		{
		}
