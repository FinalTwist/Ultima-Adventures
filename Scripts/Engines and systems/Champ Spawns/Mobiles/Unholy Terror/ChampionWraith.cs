...
namespace Server.Mobiles
{
	...
	public class ChampionWraith : BaseCreature
	{
		[Constructable]
		public ChampionWraith() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionWraith( Serial serial ) : base( serial )
		{
		}
