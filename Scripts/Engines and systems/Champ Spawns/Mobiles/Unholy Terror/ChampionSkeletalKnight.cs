...
namespace Server.Mobiles
{
	...
	public class ChampionSkeletalKnight : BaseCreature
	{
		[Constructable]
		public ChampionSkeletalKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionSkeletalKnight( Serial serial ) : base( serial )
		{
		}
