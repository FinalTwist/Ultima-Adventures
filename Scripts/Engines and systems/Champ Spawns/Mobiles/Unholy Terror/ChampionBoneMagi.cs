...
namespace Server.Mobiles
{
	...
	public class ChampionBoneMagi : BaseCreature
	{
		[Constructable]
		public ChampionBoneMagi() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionBoneMagi( Serial serial ) : base( serial )
		{
		}
