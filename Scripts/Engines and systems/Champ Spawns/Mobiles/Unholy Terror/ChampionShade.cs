...
namespace Server.Mobiles
{
	...
	public class ChampionShade : BaseCreature
	{
		[Constructable]
		public ChampionShade() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionShade( Serial serial ) : base( serial )
		{
		}
