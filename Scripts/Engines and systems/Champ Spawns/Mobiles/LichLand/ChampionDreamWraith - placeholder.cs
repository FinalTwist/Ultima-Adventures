...
/* Based on Wraith... Still no infos on Dream Wraith, including correct body ID */
using System;
using Server;
using Server.Items;
...
namespace Server.Mobiles
{
	...
	public class ChampionDreamWraith : BaseCreature
	{
		[Constructable]
		public ChampionDreamWraith() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionDreamWraith( Serial serial ) : base( serial )
		{
		}
