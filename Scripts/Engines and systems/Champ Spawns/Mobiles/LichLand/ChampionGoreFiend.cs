...
{
	[CorpseName( "a gore fiend champion corpse" )]
	public class ChampionGoreFiend : BaseCreature
	{
		[Constructable]
		public ChampionGoreFiend() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionGoreFiend( Serial serial ) : base( serial )
		{
		}
