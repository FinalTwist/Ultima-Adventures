...
namespace Server.Mobiles
{
	...
	public class ChampionDarkWisp : BaseCreature
	{
		...
		[Constructable]
		public ChampionDarkWisp() : base( AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionDarkWisp( Serial serial ) : base( serial )
		{
		}
