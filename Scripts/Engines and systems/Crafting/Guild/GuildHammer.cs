    ...
    public class GuildHammer : Item
    {
        ...
        public override void OnDoubleClick( Mobile from )
        {
			if ( from is PlayerMobile )
			{
				...
				if ( pc.NpcGuild != NpcGuild.BlacksmithsGuild && from.Skills[SkillName.Blacksmith].Value < 110 )
				{
					from.SendMessage( "Only those of the Blacksmiths Guild may use this, or those with elder skills." );
				}
