...
namespace Server.Mobiles
{
	...
	public class WeakSentry : BaseCreature
	{
		...
		[Constructable]
		public WeakSentry() : this( 2 )
		{
		}

		[Constructable]
		public WeakSentry( int oreAmount ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a basic sentry";
			Body = 14;
		...
		public WeakSentry( Serial serial ) : base( serial )
		{
		}
