...
namespace Server.Engines.BulkOrders
{
	...
	public class SmallCarpenterBOD : SmallBOD
	{
		...
		public static SmallCarpenterBOD CreateRandomFor( Mobile m, bool defaultMaterialOnly = true )
		{
            ...
            {
                default:
                case 0: entries = SmallBulkEntry.CarpenterArmor; break;
                case 1: entries = SmallBulkEntry.CarpenterInstrument; break;
                case 2: entries = SmallBulkEntry.CarpenterWeapons; break;
            }
