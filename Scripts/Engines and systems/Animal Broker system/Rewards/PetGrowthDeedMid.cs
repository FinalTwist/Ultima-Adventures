...
{ 
   public class GrowthTargetMid : Target 
   { 
      private PetGrowthDeedMid m_Deed; 

      public GrowthTargetMid( PetGrowthDeedMid deed ) : base( 1, false, TargetFlags.None ) 
      { 
         m_Deed = deed; 
      } 
         ...
         { 
            ...
            { 
               ...
               { 
                  ...
                  int amnt = Utility.RandomMinMax(2,3);
   ...
   public class PetGrowthDeedMid : Item // Create the item class which is derived from the base item class 
   { 
      [Constructable] 
      ...
      public PetGrowthDeedMid( Serial serial ) : base( serial ) 
      { 
      } 
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			base.GetProperties( list );
				...
				list.Add("Adds 2 to 3 points to one of your pet's attributes." ); 
		}
      ...
      { 
         ...
         { 
            ...
            from.Target = new GrowthTargetMid( this ); // Call our target 
          } 
      }    
   } 
}