...
{ 
   public class GrowthTargetStrong : Target 
   { 
      private PetGrowthDeedStrong m_Deed; 

      public GrowthTargetStrong( PetGrowthDeedStrong deed ) : base( 1, false, TargetFlags.None ) 
      { 
         m_Deed = deed; 
      } 
   ...
   public class PetGrowthDeedStrong : Item // Create the item class which is derived from the base item class 
   { 
      [Constructable] 
      public PetGrowthDeedStrong() : base( 0x2827 ) 
      { 
         Weight = 1.0; 
         Name = "a strong experimental growth potion"; 
         Stackable = true; 
	      Hue = 1177;
      } 

      public PetGrowthDeedStrong( Serial serial ) : base( serial ) 
      { 
      } 
