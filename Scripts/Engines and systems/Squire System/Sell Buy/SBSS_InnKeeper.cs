...
{
	public class SBSS_InnKeeper : SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

		public SBSS_InnKeeper()
		{
		}
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				Add( new GenericBuyInfo( typeof( RoomAttendantContract ), 50000, 10, 0x14F0, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( PewterBowlOfFoodPotatos ), 3, 20, 0x1601, 0 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( PewterBowlOfFoodPotatos ), 1 );
