...
{
	[Flipable]
	public class SBLeatherGloves : BaseArmor, IArcaneEquip, ITailorRepairable
    {
		...
		[Constructable]
		public SBLeatherGloves() : base( 0x13C6 )
		{
			Weight = 1.0;
		}

		public SBLeatherGloves( Serial serial ) : base( serial )
		{
		}
