...
namespace Server.Mobiles
{
	public class Mannequin : BaseCreature
	{
		...
		public override void OnSpeech( SpeechEventArgs args )
		{
			...
			if( (said == "you're fired" || said == "dismiss") && m_Listen && from == m_Owner )
			{
		...
		public override void AddNameProperties( ObjectPropertyList list )
		{
			...
			if (m_Owner != null)
			{
					list.Add( "This mannequin is owned by " + m_Owner.Name ); 
			}
			list.Add( "Can be renamed and interacted with by speaking its name."); 
			list.Add( "To remove, owner must say 'dismiss'."); 
		}
