...
{
    public class ElementalWeightingStone : WeightingStoneBase
    {
        [Constructable]
        ...
        [Constructable]
        public ElementalWeightingStone(int uses) : base(uses, 70, 100)
        {
        ...
        protected override bool Validate(Mobile from, BaseWeapon weapon)
        {
            ...
            {
                from.SendMessage(32, "You need at least 100 Blacksmith and 100 Magery to weight weapons with this stone");
                return false;
            }
