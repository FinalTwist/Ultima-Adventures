...
{
	public class DenseWeightingStone : Item
	{
		private int i_Uses;
		...
		[Constructable] 
		public DenseWeightingStone( int uses ) : base( 0x1F14 ) 
		{ 
			Weight = 1.0;
			i_Uses = uses;
			Hue = 0x38C;
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( IsChildOf( from.Backpack ) )
			{
				...
				from.Target = new DenseWeightingStoneTarget(this);
			}
			else
	...
	public class DenseWeightingStoneTarget : Target
	{
		private DenseWeightingStone sb_Blade;

		public DenseWeightingStoneTarget(DenseWeightingStone blade) : base( 18, false, TargetFlags.None )
		{
			sb_Blade = blade;
		}
