...
{
	public class ShadowIronStone : Item
	{
		public override string DefaultName
		{
			get { return "an ShadowIronIngot stone"; }
		}

		[Constructable]
		public ShadowIronStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 0x966;
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				ShadowIronIngot ingotBag = new ShadowIronIngot( 800 );
		...
		public ShadowIronStone( Serial serial ) : base( serial )
		{
		}
