...
{
	public class GoldStone : Item
	{
		public override string DefaultName
		{
			get { return "an GoldIngot stone"; }
		}

		[Constructable]
		public GoldStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 0x8A5;
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				GoldIngot ingotBag = new GoldIngot( 300 );
		...
		public GoldStone( Serial serial ) : base( serial )
		{
		}
