...
namespace Server.Items
{
	...
	public class LevelAttributes
	{
		...
		public static WeaponAttributeInfo[] m_WeaponAttributes = new WeaponAttributeInfo[]
		{
			...
			new WeaponAttributeInfo( AosWeaponAttribute.HitLightning, "Hit Lightning", AttributeCategory.Hits, 4, 50 ),
        ...
        public static ArmorAttributeInfo[] m_ArmorAttributes = new ArmorAttributeInfo[]
		{
            ...
            new ArmorAttributeInfo( AosArmorAttribute.MageArmor, "Mage Armor", AttributeCategory.Magic, 10, 1 ),
		...
		/*public static QuiverAttributesInfo[] m_QuiverAttributes = new QuiverAttributesInfo[]
		{
			new QuiverAttributesInfo( LowerAmmoCost,"Lower Ammo Cost",AttributeCategory.Misc,2,75),
			new QuiverAttributesInfo( WeightReduction,"Weight Reduction",AttributeCategory.Misc,2,50),
			new QuiverAttributesInfo( DamageIncrease,"Damage Modifier",AttributeCategory.Misc,5,100)
		};*/
	}
	...
	public class QuiverAttributesInfo
    {
		public BaseQuiver m_Attribute;
		public string m_Name;
		public AttributeCategory m_Category;
		public int m_XP;
		public int m_MaxValue;

		public QuiverAttributesInfo(BaseQuiver attribute, string name, AttributeCategory category, int xp, int maxvalue)
		{
			m_Attribute = attribute;
			m_Name = name;
			m_Category = category;
