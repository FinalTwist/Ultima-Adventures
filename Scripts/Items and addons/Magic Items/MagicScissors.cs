		...
		private class WearTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
							...
							iWear is LevelSash )
				{
					...
					else if ( iWear.ItemID == 0x1F7B ){ DoEffects = true; iWear.ItemID = 0x1541; OldName = "doublet"; NewName = "sash"; }
					else if ( iWear.ItemID == 0x1541 ){ DoEffects = true; iWear.ItemID = 0x1FA1; OldName = "sash"; NewName = "tunic"; }
					else if ( iWear.ItemID == 0x1FA1 ){ DoEffects = true; iWear.ItemID = 0x1FFD; OldName = "tunic"; NewName = "surcoat"; }
					else if ( iWear.ItemID == 0x1FFD ){ DoEffects = true; iWear.ItemID = 0x27A1; OldName = "surcoat"; NewName = "jin baori"; }
					else if ( iWear.ItemID == 0x27A1 ){ DoEffects = true; iWear.ItemID = 0x1F7B; OldName = "jin baori"; NewName = "doublet"; }
